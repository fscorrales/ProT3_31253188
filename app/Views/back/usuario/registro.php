            ...
            <div class="card-body" media="(max-width: 768px)"> 
                <form method="post" action="<?php echo base_url('/enviar-form'); ?>">
                    <div class="mb-3">
                        ...
                        value="<?php if(session('msg')) {echo $usuario['nombre'];} ?>">
                        <!-- Error -->
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php if(session('msg')) {echo $usuario['apellido'];} ?>">
                        <!-- Error -->
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php if(session('msg')) {echo $usuario['email'];} ?>">
                        <!-- Error -->
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php if(session('msg')) {echo $usuario['usuario'];} ?>">
                        <!-- Error -->
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php if(session('msg')) {echo $usuario['pass'];} ?>">
                        <!-- Error -->
